...
namespace Microsoft.Azure.Management.Storage.Fluent
{
    ...
    internal partial class StorageSkusImpl  :
        ReadableWrappers<Microsoft.Azure.Management.Storage.Fluent.IStorageSku,Microsoft.Azure.Management.Storage.Fluent.StorageSkuImpl,Models.Sku>,
        IStorageSkus
    {
        ...
        {
            return WrapList(Extensions.Synchronize(() => this.Inner().ListAsync()));
        }
        ...
        {
            return await PagedCollection<IStorageSku, Models.Sku>.LoadPage(this.Inner().ListAsync, WrapModel, cancellationToken);
        }

        ///GENMHASH:C852FF1A7022E39B3C33C4B996B5E6D6:226463FFB9926F982826109D59B16399
        public ISkusOperations Inner()
        {
            return this.manager.Inner.Skus;
        }

        ///GENMHASH:28117D4506FD6B9653E07FBD1120F0F0:003BFC8148CD6CF7CA3D305BF153CAAB
        protected override IStorageSku WrapModel(Models.Sku inner)
        {
