...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnN0b3JhZ2UuaW1wbGVtZW50YXRpb24uVGFibGVTZXJ2aWNlRW5jcnlwdGlvblN0YXR1c0ltcGw=
    internal partial class TableServiceEncryptionStatusImpl  : StorageAccountEncryptionStatusImpl
    {
        ...
        {
            if (base.encryptionServices == null)
            {
                return null;
            }
            else
            {
                return base.encryptionServices.Table;
            }
        }
        ...
        {
            return Microsoft.Azure.Management.Storage.Fluent.StorageService.Table;
        }
