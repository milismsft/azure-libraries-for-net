...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnN0b3JhZ2UuaW1wbGVtZW50YXRpb24uU3RvcmFnZUFjY291bnRFbmNyeXB0aW9uU3RhdHVzSW1wbA==
        ...
        IStorageAccountEncryptionStatus
    {
        ...
        DateTime? IStorageAccountEncryptionStatus.LastEnabledTime => this.LastEnabledTime();

        bool IStorageAccountEncryptionStatus.IsEnabled => this.IsEnabled();
        ...
        protected virtual DateTime? LastEnabledTime()
        {
            var encryptionService = this.EncryptionService();
