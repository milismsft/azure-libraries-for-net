...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnN0b3JhZ2UuaW1wbGVtZW50YXRpb24uRmlsZVNlcnZpY2VFbmNyeXB0aW9uU3RhdHVzSW1wbA==
    internal partial class FileServiceEncryptionStatusImpl  : StorageAccountEncryptionStatusImpl
    {
        ...
        protected override EncryptionService EncryptionService()
        {
            ...
            {
                return base.encryptionServices.File;
            }
        }
        ...
        {
            return Microsoft.Azure.Management.Storage.Fluent.StorageService.File;
        }
    }
}