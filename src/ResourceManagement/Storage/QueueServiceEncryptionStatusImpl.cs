...
///GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnN0b3JhZ2UuaW1wbGVtZW50YXRpb24uUXVldWVTZXJ2aWNlRW5jcnlwdGlvblN0YXR1c0ltcGw=
    internal partial class QueueServiceEncryptionStatusImpl  : StorageAccountEncryptionStatusImpl
    {
        ...
        protected override EncryptionService EncryptionService()
        {
            ...
            {
                return base.encryptionServices.Queue;
            }
        }
        ...
        {
            return Microsoft.Azure.Management.Storage.Fluent.StorageService.Queue;
        }
    }
}